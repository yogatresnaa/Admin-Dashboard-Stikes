      ...
      <FormGroup>
        ...
        <div className="d-flex w-100%">
          <DatePicker
            ...
            onChange={(value) =>
              setFieldValue("period_start", new Date(value).getFullYear())
            }
      ...
      <FormGroup>
        ...
        <div className="d-flex w-100%">
          <DatePicker
            wrapperClassName="flex-grow-1"
            selected={
              (values.period_end && new Date(values.period_end.toString())) ||
              null
            }
            onChange={(value) =>
              setFieldValue("period_end", new Date(value).getFullYear())
            }
            className="form-control form-control-solid w-500px"
            showYearPicker
            dateFormat="yyyy"
        ...
        <ErrorComponent text={errors.period_end} error={errors.period_end} />
      </FormGroup>
