...
import { AiFillEdit, AiOutlinePlusCircle, AiOutlineRollback } from "react-icons/ai";
import { Link, createSearchParams } from "react-router-dom";
import { Col, Row, Button } from "reactstrap";

export default function ActionButton({ onBackHandler, data }) {
  return <Row md={6} noGutters className='gap-1 align-items-center'>
    <Col md={1}>
      <p className='section-title'>Setting Tarif</p>
    </Col>

    <Col md={2}>
      <Link style={{ textDecoration: 'none' }} state={{ data: data }} to={{
