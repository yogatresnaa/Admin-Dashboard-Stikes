...
function TableAkunBiaya({ data, subHeaderComponent, resetPaginationToggle, isLoading, onClickEditHandler, onClickDeleteHandler }) {
  ...
  return (
    <>
      <DataTable columns={columns} data={AkunBiaya} subHeaderComponent={subHeaderComponent} pagination />
