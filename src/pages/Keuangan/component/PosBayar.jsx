...
function TablePosABayar({ data, subHeaderComponent, resetPaginationToggle, isLoading, onClickEditHandler, onClickDeleteHandler }) {
  ...
  return (
    <>
      <DataTable columns={columns} data={dataPostBayar} subHeaderComponent={subHeaderComponent} pagination />
