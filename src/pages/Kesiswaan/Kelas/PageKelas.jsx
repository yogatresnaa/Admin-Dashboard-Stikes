  ...
  return (
    <div className='page-kelas'>
      ...
      <div className='table-kelas'>
        ...
        <TableKelas data={filterText.length > 0 ? dataKelas.filter : dataKelas.data} subHeaderComponent={subHeaderComponent} resetPaginationToggle={resetPaginationToggle} isLoading={isLoadingKelas} />
      </div>
    </div>
  );
}
