...
function TableSiswa({ data, subHeaderComponent, onClickResetPassword, onClickSeeData, onClickStatus, onClickCetak, resetPaginationToggle, isLoading, onClickEditHandler, onClickDeleteHandler }) {
  const ActionButton = (row) => (
    <div className='d-flex gap-1'>
      ...
      <OverlayTrigger overlay={<Tooltip id='tooltip-disabled'>Cetak</Tooltip>}>
        <span className='d-inline-block'>
          <Button
            color='secondary'
  ...
  return (
    <>
      <div>
        <DataTable columns={columns} data={data} selectableRows subHeaderComponent={subHeaderComponent} pagination />;
      </div>
    </>
  );
}
