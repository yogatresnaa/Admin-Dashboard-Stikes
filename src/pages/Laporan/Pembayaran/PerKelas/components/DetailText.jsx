...
export default function DetailText({ data }) {
    return (
        <div className="d-flex flex-column">
            ...
            <DetailTextItem
                title="Jenis Kelamin"
                value={data.student_gender == 'P' ? 'Perempuan' : 'Laki-laki'}
            />
            <DetailTextItem
                title="Tempat,Tanggal Lahir"
                value={`${data.student_born_place}, ${dateConvert(data.student_born_date)}`}
            />
            ...
            <DetailTextItem
                ...
                value={data.student_name_of_mother}
            />
            <DetailTextItem
                title="Nama Ayah Kandung"
                value={data.student_name_of_father}
            />
            <DetailTextItem
                title="Program Studi"
                value={data.majors_majors_name}
            />
