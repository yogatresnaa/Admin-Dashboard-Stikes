          ...
          <ul className='nav nav-pills flex' id='parentM'>
            <Link className='link' to='/admin'>
              <li className='nav-item nav-link text-black  my-1'>
                <IconContext.Provider value={{ color: '#DC84F3' }}>
                  <FaRegKeyboard style={{ width: '30px', height: '30px', background: '#E0F4FF', padding: '3px', boxShadow: 'rgba(215, 12, 12, 0.15) 1.95px 1.95px 2.6px' }} />
            ...
            <li className='nav-item my-2' onClick={toggleNav}>
              <a href='#submenu' className='nav-link text-black' data-bs-toggle='collapse' aria-current='page'>
                <IconContext.Provider value={{ color: '#DC84F3' }}>
                  <FaUserGraduate style={{ width: '30px', height: '30px', background: '#E0F4FF', padding: '3px', borderradius: '50x', boxShadow: 'rgba(215, 12, 12, 0.15) 1.95px 1.95px 2.6px' }} />
                </IconContext.Provider>
            ...
            <li className='nav-item text-white my-1 column-wrapper ' onClick={toggleNav2}>
              <a href='#submenu1' className='nav-link text-black' data-bs-toggle='collapse' aria-current='page'>
                <IconContext.Provider value={{ color: '#DC84F3' }}>
                  <BsFillMortarboardFill style={{ width: '30px', height: '30px', background: '#E0F4FF', padding: '3px', boxShadow: 'rgba(215, 12, 12, 0.15) 1.95px 1.95px 2.6px' }} />
                </IconContext.Provider>

                <span className='ms-2 text-black'>Akademik</span>
                <Navbar.Toggle aria-controls='responsive-navbar-nav' className='ms-2'>
            ...
            <li className='nav-item text-white my-1'>
              <a href='#submenu3' className='nav-link text-black' onClick={toggleNav3} data-bs-toggle='collapse' aria-current='page'>
                <IconContext.Provider value={{ color: '#DC84F3' }}>
                  <FaRegMoneyBillAlt style={{ width: '30px', height: '30px', background: '#E0F4FF', padding: '3px', borderradius: '50x', boxShadow: 'rgba(215, 12, 12, 0.15) 1.95px 1.95px 2.6px' }} />
                </IconContext.Provider>

                <span className='ms-2 text-black'>Keuangan</span>
                <Navbar.Toggle aria-controls='responsive-navbar-nav' className='ms-2'>
              ...
              <ul className='nav collapse ms-2  flex-column justify-content-end  column-wrapper  ' id='submenu3' data-bs-parent='#parentM'>
                ...
                <li className='nav-item m-1'>
                  <a href='#submenu4' className='nav-link' id='submenu5' onClick={toggleNav4} data-bs-toggle='collapse' aria-current='page' style={{ color: '#DC84F3' }}>
                    Seting Pembayaran
                    <Navbar.Toggle aria-controls='responsive-navbar-nav' className='ms-2'>
                  ...
                  <ul className='nav collapse multi-collapse ms-2 flex-column justify-content-end column-wrapper bg-ul ' id='submenu4' data-bs-parent='#submenu5'>
                    ...
                    <Link className='link color' to='/admin/kirim-tagihan'>
                      <li className='nav-item nav-link m-1' style={{ color: '#DC84F3' }}>
            ...
            <li className='nav-item text-white my-2'>
              <a href='#submenu6' className='nav-link text-black' onClick={toggleNav5} data-bs-toggle='collapse' aria-current='page'>
                <IconContext.Provider value={{ color: '#DC84F3' }}>
                  <FaRegCreditCard style={{ width: '30px', height: '30px', background: '#E0F4FF', padding: '3px', borderradius: '50x', boxShadow: 'rgba(215, 12, 12, 0.15) 1.95px 1.95px 2.6px' }} />
                </IconContext.Provider>

                <span className='ms-2 text-black'>Kas Bank&nbsp;</span>
                <Navbar.Toggle aria-controls='responsive-navbar-nav' className='ms-2'>
            ...
            <li className='nav-item text-white my-1'>
              <a href='#submenu7' className='nav-link text-black' onClick={toggleNav6} data-bs-toggle='collapse' aria-current='page'>
                ...
                <span className='ms-2 text-black'>Laporan &nbsp;</span>
                <Navbar.Toggle aria-controls='responsive-navbar-nav' className='ms-2'>
              ...
              <ul className='nav collapse ms-2  flex-column justify-content-end  column-wrapper ' id='submenu7' data-bs-parent='#parentM'>
                <li className='nav-item'>
                  <a href='#submenu4' className='nav-link ' id='submenu5' onClick={toggleNav7} data-bs-toggle='collapse' aria-current='page' style={{ color: '#DC84F3' }}>
                    Laporan Pembayaran
                    <Navbar.Toggle aria-controls='responsive-navbar-nav' className='ms-2'>
