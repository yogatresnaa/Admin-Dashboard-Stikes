...
export default function CustomSelect({ includeAll = false, withLabel = true, data, value, onChange, name, labelName, optionName, optionValue, optionNameOptional = '', symbol = '-' }) {
  return (
    <>
      {
        withLabel ?
